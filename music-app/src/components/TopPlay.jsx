...
import { useGetTopChartsQuery } from '../redux/services/index';
    ...
    >
      <div className="w-full flex flex-col">
        <div className="flex flex-row justify-between items-center">
          ...
          <Link to="/top-charts">
            <p className="text-gray-300 taxt-base cursor-pointer">See more</p>
          </Link>
        </div>
        ...
        >
          {topPlays?.map((song, i) => (
            <SwiperSlide
              ...
              className="shadow-lg rounded-full animate-sliderunght"
            >
              <Link to={`/artists/${song?.artists[0].adamid}`}>
                <img
